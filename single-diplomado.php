		...
		<div class="ed-item s-100 m-60 lg-70	">
			<div class="single-banner__wrap ">
				<figure class="single-banner__figure">
					<?php $curso_image = get_field( 'diploma_imagen' ); ?>
					<?php if ( $curso_image ) { ?>
			...
			<div class="single-banner__info  ">
				...
				<div class="ed-grid s-grid-1  lg-grid-2 rows-gap cols-gap-none ">
					<div class="single-banner__section  ">
						...
						<p>
							<strong>INICIO</strong>: <?php the_field( 'diploma_fecha' );?>
						</p>
					</div>
					<div class="single-banner__section ">
						<div class="single-banner__svg-wrap s-cross-center s-main-center s-to-center">
						...
						<p>
							<strong>CERTIFICACIÓN</strong>: <?php the_field( 'diploma_horas' ); ?>
						</p>
					</div>
					<div class="single-banner__section ">
						<div class="single-banner__svg-wrap s-cross-center s-main-center s-to-center">
						...
						<p >
							<strong>DÍAS</strong>: <?php the_field( 'diploma_dias' ); ?> 
						</p>
					</div> 
					<div class="single-banner__section ">
						...
						<p>
							<strong>HORARIOS</strong>: <?php the_field( 'diploma_hora_inicio' ); ?>
						</p>
					</div>
					<div class="single-banner__section ">
						<div class="single-banner__svg-wrap s-cross-center s-main-center s-to-center">
						...
						<p>
							<strong>INVERSIÓN</strong>: 	<span> <?php the_field( 'diploma_precio' ); ?> </span>
						</p>
					</div>
				</div>
				<div class="ed-grid s-1-3">
					<a class="btn-brochure  " target="_blank" href="<?php the_field( 'diploma_temario_url' ); ?>">
	...
	<div class="ed-container">
		<div class="ed-item s-100 m-100 lg-70 margin-r-l-0">
			<ul class="tabs ed-container">
				<li class="tab ed-item s-20 m-20 l-20"> <a  href="#curso">Presentación</a> </li>
				<li class="tab ed-item s-20 m-20 l-20"> <a class="active" href="#temario">Temario</a> </li>
			...
			<div class="single-tabs__info p-r-l-05">
				<div id="curso" class="col s12 single-showtabs">
					<h1 class="single-showtabs__title">Presentacion del Diplomado</h1>
				...
				<div id="temario" class="single-showtabs col s12 ">
					...
					<div class="single-showtabs__body">
						<?php // the_field( 'diploma_temario' ); ?>  
						<ul class="collapsible">
						<?php 
							if( have_rows('diploma_temario') ):  
									while ( have_rows('diploma_temario') ) : the_row();  
												$diploma_temario_title = get_sub_field('diploma_temario_titulo');  	
												$diploma_temario_description = get_sub_field('diploma_temario_descripcion');  
										?> 
												<li>
												<div class="collapsible-header"><i class="material-icons add">add</i><i class="material-icons remove">remove</i> <?php echo $diploma_temario_title; ?></div>
												<div class="collapsible-body"><span><?php echo $diploma_temario_description; ?></span></div>
												</li> 
								 <?php   
									endwhile; 
							else : 
				...
				<div id="docentes" class="col s12 single-showtabs">
					...
					<div class="single-showtabs__body ed-container">  
							<?php 
							if( have_rows('diploma_profesores') ):  
									while ( have_rows('diploma_profesores') ) : the_row();  
												$image = get_sub_field('diploma_profesor_imagen');  	
												$biografia = get_sub_field('diploma_profesor_biografia');  
										?>
										<div class="single-teacher__wrap ed-item s-100 m-100 l-100    m-to-center ed-container">
											<div class="single-teacher ed-item s-100 m-50 l-50"> 
												...
												<?php if( have_rows('diploma_profesor_informacion') ):  
														while( have_rows('diploma_profesor_informacion') ): the_row();  
														// vars
															$nameandlast = get_sub_field('diploma_profesor_nombres_y_apellidos');
															$profession = get_sub_field('diploma_profesor_profesion');?>
				...
				<div id="beneficios" class=" benefits col s12 single-showtabs">
					<h2 class="single-showtabs__title">Beneficios por adquirir el diplomado</h2>
					<div class="single-showtabs__body">
					<div class="benefits-gift ed-grid s-grid-12  m-grid-12 lg-grid-12 margin-r-l-0" >
							...
							<div class="benefits-gift__item s-cols-12 m-cols-6 lg-cols-6"><h1>Participación en el Diploma </h1> </div>
				...
				<div id="inversion" class="col s12 single-showtabs">
					...
					<div class="single-showtabs__body">
						<h3 class="fw-normal">INVERSIÓN</h3>
						<div class="single-investment ed-grid s-grid-1  m-grid-2 lg-grid-2 gap-0" >   
								<div class="single-investment__section1 s-cross-center s-main-center s-to-center" >
									<div>
										<h3>Incluido el IGV</h3><br>
										<span> <?php the_field( 'diploma_precio' ); ?> </span>
									</div> 
								</div> 
								<div class="single-investment__section2" > 
										<h3>FINANCIAMIENTO EN CUOTAS</h3> <br>
						...
						<h3 class="fw-normal">FORMAS DE PAGO</h3>  
