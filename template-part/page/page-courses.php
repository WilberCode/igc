            ...
            <!--   <div class="page-banner" > 
              <div class="ed-container">
                    <div class="ed-item p-m-rl-5">--> 
                        <!--
                         <img class="page-cursos__img"  src=" <?php// echo main_image_url('full');  ?>" alt="<?php the_title();?>"> 
                        <p>Capacitación y actualización en cursos y seminarios en todos las áreas administrativas, Contables, Tributarios,
                        Financieros, Recursos Humanos, tecnológicos y gerenciales de entidades públicas y privadas.</p> 
                    </div>
                </div>
            </div> -->
            <div class="ed-container">
                <div class="ed-item p-m-rl-5">
                    <div id="" class="courses ">  
