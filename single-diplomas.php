...
<?php if($diploma_banner){
    ...
    $bg_current  = $diploma_banner['diploma_banner_color'];
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5 ">
                <div  class="col-span-2" >  
                    <div  class="flex  items-center space-x-2 text-white italic ">
                           <?php   ?>
                           <div><span  class="w-10 h-10 rounded-12 bg-black bg-opacity-30 flex justify-center items-center " ><svg class="w-6 h-6 text-white fill-current" ><use href="<?php echo get_bloginfo('template_directory').'/build/svg/icons.svg#diploma';?>"></svg></span></div>
                     ...
                     ?>  
                      <div class="data mt-8" >
                        <?php if (get_field('curso_inicio')){ ?>
                           <div class="data-item "> 
                                 <div class="data-item-icon"><svg ><use href="<?php echo get_bloginfo('template_directory').'/build/svg/icons.svg#calendar';?>"></svg> </div>
   ...
   <div class="container m-auto">
       <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 mt-6 lg:mt-4"> 
           <div class="main lg:col-span-2   "> 
                                 ...
                                 <li>
                                       ...
                                       <div  class="info-body" >
                                             ...
                                             <?php if($curso_beneficios_opcion['curso_beneficios_opciones_descripcion']){?> 
                                                <p><?=$curso_beneficios_opcion['curso_beneficios_opciones_descripcion']; ?></p>  
                                             <?php  }?>
                                       </div>
                                    </li> 
                               <?php    
               ...
               $curso_docentes = get_field('curso_docentes');  
                  if( $curso_docentes){ ?>
                          <section class="section"  id="docentes">
                              <h2 >Plana Docente</h2>   
                              <?php 
                               $diploma_docentes_descripcion =  get_field('diploma_docentes_descripcion','option');
                               if ($diploma_docentes_descripcion) {  
                              ?>
                                 <div class="my-3">
                                    <?=$diploma_docentes_descripcion; ?>
                                 </div>
                              <?php  }  ?>
                                          ...
                                          <div class=" teacher-avatar lg:col-span-1  inline-flex  nowrap items-center justify-center lg:justify-between  ">  
                                             <div class="">
                                                   <div class="text-center text-white   w-full  lg:w-52 px-4 py-6 relative z-[4]  card-decorator  "  style="background:linear-gradient(11deg, var(--bg-third)  0%,<?php echo $bg_current;?>  100%)">
                                                      ...
                                                      <h6 class="mt-2 text-current "> <?=$curso_docente->post_title ?> </h6>
            ...
            <?php
               $diploma_comunicate = get_field('diploma_comunicate','option');
               if( $diploma_comunicate ){ ?>  
                  <section class="section">
                     ...
                     <div class="md:flex  w-full mt-3 bg-white   rounded-card  overflow-hidden  p-2 border  " style="border-color:<?php echo $bg_current.'12';?>" >
                        <div class="   flex flex-col items-center justify-center py-12 px-6 w-full md:w-2/5  "  >
                              <h5><?=$diploma_comunicate['diploma_comunicate_descripcion'];?></h5>
                        </div>
                        <div  class=" rounded-card   flex items-center justify-center py-12 px-6 w-full  md:w-3/5" style="background-color:<?php echo $bg_current.'0a';?>"> 
                           <div >  
                           <?php  
                                    $diploma_comunicate_contactos = $diploma_comunicate['diploma_comunicate_contactos'];
                                
                                    if($diploma_comunicate_contactos){    
                                       foreach( $diploma_comunicate_contactos as $diploma_comunicate_contacto ) {  
                                          $tag = '';
                                          $tag_close='';
                                          if($diploma_comunicate_contacto['diploma_comunicate_contactos_enlace_activo']){ 
                                             $tag = '<a href="'.$diploma_comunicate_contacto['diploma_comunicate_contactos_enlace'].'" target="_blank">  ';
                                             $tag_close = '</a>';
                                           } else{
                                             $tag = '<div>';
                                             $tag_close  = '</div>';
                                                   ...
                                                   <address class="contactinfo-data">
                                                      <div>  
                                                            <div  class="contactinfo-icon">
                                                                   <img class="style-svg" src="<?=$diploma_comunicate_contacto['diploma_comunicate_contactos_icono'] ?>"> 
                                                            </div>  
                                                      </div>
                                                      <div class="contactinfo-content" >  
                                                            <h5 class="contactinfo-content-name"><?=$diploma_comunicate_contacto['diploma_comunicate_contactos_nombre'] ?></h5> 
                                                            <p class="contactinfo-content-description"><?=$diploma_comunicate_contacto['diploma_comunicate_contactos_medio'] ?></p> 
                                                      </div> 
                                                   </address>   
                                          <?=$tag_close;?>
                                    <?php    
                  ...
                  <section  class=" aside-content  card-decorator overflow-hidden bg-white lg:sticky   z-40 w-full max-w-[421px] mx-auto   lg:top-[88px]" > 
                     <div class="rounded-card overflow-hidden p-[2px] " style="background-color:<?php echo $bg_current.'0a';?>" >
                        ...
                        <div  class="px-4 sm:px-6">
                           <?php dynamic_sidebar('diploma-form');?>   
                        </div>
