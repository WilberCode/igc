<div id="diplomas" class="col s12">  
    <h1 class="courses__title s-center m-center lg-center">Diplomados de Gestion Pública</h1> 
    <div class="card-container ed-grid s-grid-1 m-grid-2 lg-grid-2 xl-grid-2 rows-gap gap-2"> 
        ...
        <div class="s-center"> 
                <a class=" btn-more " href="<?php echo get_home_url(); ?>/diplomados"> Ver más Diplomas</a>
